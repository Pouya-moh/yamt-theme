...
;;; yamt-theme.el --- Emacs theme with a dark background.

;; Copyright (C) 2014 , pouya-moh
 ...
 (let ((class '((class color) (min-colors 89)))
   ...
   'yamt
	...
	`(cursor ((,class (:background ,bg3))))
        ...
        `(isearch ((,class (:bold t :foreground ,black :background ,search))))
